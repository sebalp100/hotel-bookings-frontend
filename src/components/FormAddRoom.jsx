...
const FormAddRoom = () => {
  ...
  return (
    <div className="bg-neutral-200 w-[400px] h-[500px] text-white">
      <form
        className="flex flex-col justify-between items-start w-[400px] h-[400px] "
      ...
      >
        ...
        <label htmlFor={tv}>
          TV:
          <input type="text" value={tv} onChange={(e) => setTv(e.target.value)} />
        </label>
        <br />
